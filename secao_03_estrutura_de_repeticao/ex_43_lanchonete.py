...
def fechar_conta(*itens):
    ...
    # print(f'| {especificacao}'.ljust(18), f'| {codigo}    | {preco_unitario:.2f}                |          {quantidade} |       {int(preco):.2f} |')

    # # quantidade_total = sum(quantidade)
    # # preco_total = sum(preco)

    # print('|---------------------------------------------------------------------------|')
    # print('| Total Geral:'.ljust(49), f'|{quantidade:>11} |{preco:>11.2f} |')
    # print('-----------------------------------------------------------------------------')
